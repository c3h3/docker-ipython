...
RUN cd /tmp && git clone https://github.com/c3h3/ipython.git && cd /tmp/ipython &&  git checkout f83f7d27abb227eea362ef && python setup.py install && rm -rf /tmp/ipython && pip install pyzmq jinja2 tornado 
